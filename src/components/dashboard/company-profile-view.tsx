...
export function CompanyProfileView({
  ...
  return (
    <div className="flex flex-col gap-4 p-5">
      <OrgFieldsSection data={data} patchUrl={`/api/companies/${data.id}`} />
      ...
      <div>
        <div className="mb-2 flex items-center justify-between">
          <div className="text-xs font-semibold uppercase tracking-wider text-foreground">{t("company.detail.memberList")}</div>
