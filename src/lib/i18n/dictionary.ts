...
export const dictionary = {
  ...
  "org.summaryEmpty": { en: "No summary yet — add a note so future-you remembers why this matters.", uk: "Ще немає саммарі — додайте нотатку, щоб майбутній ви пам'ятав, чому це важливо." },
  "org.addPerson": { en: "+ Add person", uk: "+ Додати людину" },
  "org.addPersonPlaceholder": { en: "Choose a contact…", uk: "Оберіть контакт…" },
  ...
  "historyGraph.today": { en: "Today", uk: "Сьогодні" },
  ...
  "historyGraph.addNote": { en: "+ Add note", uk: "+ Додати нотатку" },
  "historyGraph.selectEntity": { en: "Who is this about?", uk: "Про кого цей запис?" },
  "historyGraph.viewCanvas": { en: "Canvas view", uk: "Вигляд полотна" },
  "historyGraph.viewAgenda": { en: "Agenda view", uk: "Вигляд порядку денного" },
  "historyGraph.agendaEmpty": { en: "Nothing in this range.", uk: "У цьому діапазоні нічого немає." },
  "historyGraph.followUp": { en: "Follow-up", uk: "Наступний крок" },
  "historyGraph.addFollowUp": { en: "+ Set a follow-up", uk: "+ Додати наступний крок" },
  "historyGraph.followUpDatePlaceholder": { en: "Remind me to…", uk: "Нагадати про…" },
  "historyGraph.addNotePlaceholder": { en: "What happened?", uk: "Що сталося?" },
  "historyGraph.deleteConfirm": { en: "Delete this interaction? This can't be undone.", uk: "Видалити цю взаємодію? Це неможливо скасувати." },
  "historyGraph.reschedule": { en: "Edit date & type", uk: "Змінити дату й тип" },
  ...
  "cluster.expandFull": { en: "Open full screen", uk: "Відкрити на весь екран" },
  "cluster.newEntry": { en: "+ New entry", uk: "+ Новий запис" },
  "cluster.newEntryPlaceholder": { en: "What happened?", uk: "Що сталося?" },
  ...
  "inspector.field.instagram": { en: "Instagram", uk: "Instagram" },
  "inspector.field.whatsapp": { en: "WhatsApp", uk: "WhatsApp" },
  "inspector.field.city": { en: "City", uk: "Місто" },
  "inspector.field.country": { en: "Country", uk: "Країна" },
